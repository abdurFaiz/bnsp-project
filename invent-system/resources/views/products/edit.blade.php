        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="desc_product" id="desc_product" rows="3"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('desc_product') border-red-300 @enderror">{{ old('desc_product', $product->desc_product) }}</textarea>
                @error('desc_product')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="harga_product" id="harga_product"
